...
public class BerylMatrix {
     ...
     */
    public BerylMatrix(BerylVector col1, BerylVector col2, BerylVector col3, BerylVector col4) {
        m00 = col1.x;
        m10 = col1.y;
        m20 = col1.z;
        m30 = col1.w;
     ...
     */
    public BerylMatrix add(BerylMatrix other) {
    	BerylMatrix result = new BerylMatrix();
     ...
     */
    public BerylMatrix subtract(BerylMatrix other) {
     ...
     */
    public BerylMatrix multiply(float scalar) {
    	BerylMatrix result = new BerylMatrix();
     ...
     */
    public BerylVector multiply(BerylVector vector) {
        ...
        return new BerylVector(x, y, z, w);
    }
     ...
     */
    public BerylMatrix multiply(BerylMatrix other) {
    	BerylMatrix result = new BerylMatrix();
     ...
     */
    public static BerylMatrix orthographic(float left, float right, float bottom, float top, float near, float far) {
    	BerylMatrix ortho = new BerylMatrix();
     ...
     */
    public static BerylMatrix frustum(float left, float right, float bottom, float top, float near, float far) {
    	BerylMatrix frustum = new BerylMatrix();
     ...
     * @return Perspective matrix
     */
    public static BerylMatrix perspective(float fovy, float aspect, float near, float far) {
    	BerylMatrix perspective = new BerylMatrix();
     ...
     */
    public static BerylMatrix translate(float x, float y, float z) {
    	BerylMatrix translation = new BerylMatrix();
     ...
     * @return Translation matrix
     */
    public static BerylMatrix translate(BerylVector translateBy) {
    	BerylMatrix translation = new BerylMatrix();
     ...
     */
    public static BerylMatrix rotate(float angle, float x, float y, float z) {
    	BerylMatrix rotation = new BerylMatrix();

        float c = (float) Math.cos(Math.toRadians(angle));
        float s = (float) Math.sin(Math.toRadians(angle));
        BerylVector vec = new BerylVector(x, y, z);
        if (vec.squaredMagnitude() != 1f) {
            vec = vec.normalize();
            x = vec.x;
            y = vec.y;
            z = vec.z;
     ...
     * @return Rotation matrix
     */
    public static BerylMatrix rotate(float angle, BerylVector axis) {
     ...
     */
    public static BerylMatrix scale(float x, float y, float z) {
    	BerylMatrix scaling = new BerylMatrix();
     ...
     * @return Scaling matrix
     */
    public static BerylMatrix scale(BerylVector scale) {
    	BerylMatrix scaling = new BerylMatrix();
    ...
    /**
     * Inverts this matrix. MESA GLU IMPLEMENTATION
     *
     * @return Inverted matrix
     */
    public BerylMatrix invert() {
    	BerylMatrix result = new BerylMatrix();
