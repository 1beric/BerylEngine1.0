...
public class GUIText {
	 ...
	 */
	public GUIText(TextGUI data, FontType font) {
		this.textString = data.getText();
		this.fontSize = data.getFontSize();
		this.font = font;
		this.position = data.calcScreenPos();
		this.lineMaxSize = data.getMaxLineLength();
		this.centerText = data.isCentered();
		this.centerTextVertically = data.isCenteredVertically();
	 ...
	 */
	protected boolean isCenteredVertically() {
